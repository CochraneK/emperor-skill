...
ROOT = "D:/2026/WB项目/emperor-skill/skills/nanbeichao"
PKGS = ["liuyu-perspective", "liuyifu-perspective", "liuyilong-perspective",
        "liushao-perspective", "liujun-perspective", "liuziye-perspective",
        "liuyu-ming-perspective", "liuyu-cangwu-perspective"]
...
for pkg in PKGS:
    ...
    if module != "nanbeichao-emperors" or group != "nanbeichao-main":
        all_ok = False
...
outpath = "D:/2026/WB项目/emperor-skill/_redo_tools/_verify_nanbei_song.txt"
