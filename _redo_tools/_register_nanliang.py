# -*- coding: utf-8 -*-
"""把南梁 6 帝登记进主仓 data/modules.json 的 nanbeichao-emperors 模块。
南朝宋8 + 南齐7 已建好 module/group，本批只追加 6 个新 people 键（已存在则跳过）。
"""
...
NEW = ["xiaoyan", "xiaozhengde", "xiaogang", "xiaodong", "xiaoyi", "xiaofangzhi"]
