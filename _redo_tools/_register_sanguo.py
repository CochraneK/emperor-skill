# -*- coding: utf-8 -*-
"""把三国 11 个已合规的包登记进主仓 data/modules.json。
复用 _register_xihan.py 的搬运逻辑。三国 11 帝全部 6/6 已落盘并推送。
"""
...
TARGET = {
    "sanguo": {
        "module": "sanguo-emperors", "group": "sanguo-main",
        "name": "三国帝王", "order": 18,
        "desc": "三国 11 帝（220–280，魏文帝曹丕→吴末帝孙皓）。 "
                "曹魏、蜀汉、东吴三足鼎立，皇权禅代与倾覆的博弈；"
