# -*- coding: utf-8 -*-
"""把北朝第一批·北魏5帝登记进主仓 data/modules.json 的 nanbeichao-emperors 模块。
nanbeichao module/group 已存在（南朝26帝在建），本批只追加 5 个新 people 键（已存在则跳过）。
"""
...
NEW = ["tuobagui", "tuobasi", "tuobatao", "tuobayu", "tuobajun"]
