# -*- coding: utf-8 -*-
"""独立复核南陈 5 包：不采信 worker 自报，自跑 quality_check.py + 核对结构/声明/诚实边界。"""
...
IDS = ["chenbaixian", "chenqian", "chenbozong", "chenxuan", "chenshubao"]
...
for sid in IDS:
    ...
    sk = os.path.join(base, "SKILL.md"); qc = os.path.join(base, "scripts", "quality_check.py")
...
out_path = r"D:/2026/WB项目/emperor-skill/_redo_tools/_verify_nanchen.txt"
lines = []; ALL_OK = True
for r in results:
