# -*- coding: utf-8 -*-
"""把南陈 5 帝登记进主仓 data/modules.json 的 nanbeichao-emperors 模块。
南朝宋8/南齐7/南梁6 已建好 module/group，本批只追加 5 个新 people 键（已存在则跳过）。
"""
...
NEW = ["chenbaixian", "chenqian", "chenbozong", "chenxuan", "chenshubao"]
